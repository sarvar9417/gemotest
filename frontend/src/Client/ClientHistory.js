...
export const ClientHistory = () => {
    ...
    const getConnectors = useCallback(async () => {
        try {
            const fetch = await request(`/api/connector/clienthistory/${clientId}`, 'GET', null)
    ...
    }, [request, setConnectors, setAllSections, setAllTableSections, setAllTableColumns, setAllSectionFiles])
    ...
    }, [notify, clearError, setT, getClient, getConnectors])
