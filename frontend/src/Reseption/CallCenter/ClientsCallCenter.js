...
toast.configure()
export const ClientsCallCenter = () => {
                            ...
                            if (type === "all") {
                                ...
                                return (
                                    <tr key={key} >
                                        ...
                                        <td className="fish-call text-uppercase fw-bolder" ><Link className='text-success' to={`/reseption/acceptcallcenter/${call._id}`} >{all.clients[key].lastname} {all.clients[key].firstname} {all.clients[key].fathername}</Link> </td>
                                        <td className="date text-center" >{new Date(all.clients[key].born).toLocaleDateString()}</td>
                                        <td className="id" >{all.clients[key].id}</td>
                                        <td className="phone">+{all.clients[key].phone}</td>
                                        <td className=" text-center text-success fw-normal"><Link className={call.position === "Javobsiz" ? "text-danger" : (call.position === "Qayta qo'ng'iroq" ? "text-warning" : (call.position === "Qiziqmadi" ? "text-primary" : (call.position === "O'ylab ko'radi" ? "text-info" : (call.position === "O'ylab ko'radi" ? "text-secondary" : "text-success"))))} to={`/reseption/acceptcallcenter/${call._id}`} >  {call.position}</Link> </td>
