...
toast.configure()
export const CashierClientsPages = () => {
                                                ...
                                                return (
                                                    <tr key={index} className=' border-top border-success' >
                                                        ...
                                                        <td
                                                            ...
                                                            rowSpan={all.sections[key].length + all.services[key].length}
                                                        >
                                                            <Link className='btn button-success text-success' to={`/reseption/pay/${all.clients[key]._id}/${connector._id}`} >
                                                                Qabul qilish
                                                            </Link>
                                                        </td>
                                                        <td
                                                            ...
                                                            rowSpan={all.sections[key].length + all.services[key].length}
                                                        >
                                                            <Link className='btn button-danger text-danger' to={`/reseption/pay/${all.clients[key]._id}/${connector._id}`} >
                                                                Tahrirlash
                                                            </Link>
                                                        </td>
