                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div className="member-img" data-aos="fade-up" data-aos-delay={100}>
                                <img src="assets/img/sertifikatlar/sertifikat1.jpg" className="img-fluid" alt />
                            </div>
                        </div>

                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div className="member-img" data-aos="fade-up" data-aos-delay={200}>
                                <img src="assets/img/sertifikatlar/sertifikat2.jpg" className="img-fluid" alt />
                            </div>
                        </div>

                        <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                            <div className="member-img" data-aos="fade-up" data-aos-delay={300}>
                                <img src="assets/img/sertifikatlar/sertifikat3.jpg" className="img-fluid" alt />
                            </div>
                        </div>
